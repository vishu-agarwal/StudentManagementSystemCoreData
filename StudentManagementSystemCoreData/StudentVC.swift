...
//        lbl.text = ""
            ...
            if sid == studarray[i].spid
            {
               /* let id = self.studarray[i].spid
                ...
                let action = UIAlertAction(title: "Submit", style: .default){
                   ...
                   // let stud = Student(id: id, name: name, passwd: pwd, phone: phn, std: std, age: age)
                    CoreDataHandler.shared.updatepwd(stud: stud,pwd: pwd,complition:
                    { [weak self]  in
    ...
    override func viewDidLayoutSubviews() {
        ...
        noticelbl.frame = CGRect(x:50, y: phonelbl.bottom + 2, width: 300, height: 80)
